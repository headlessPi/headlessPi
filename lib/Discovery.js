...
var Discovery = function(){
  ...
  self.sendDiscovery = function(){
    // Don't send discovery if there are no interfaces up with connectivity
    if(typeof os.networkInterfaces()['wlan0'] === 'undefined' && typeof os.networkInterfaces()['eth0'] === 'undefined') return;
    ...
    self.getIPs((ips) => {
      ...
      post_req.on('error', (err) => {
        // Ignore errors because they'll happen regularly if the unit is not online
      });
